...
TestData = TestData - mean_face;  %Obtain test data by subtracting from mean face
...
i = 100; %reconstruct the i th train image
...
figure;
subplot(1,2,1)
imagesc(reshape(x(:,i),56,46));
title('Reconstructed Image Using the Best M Eigenvectors');
subplot(1,2,2)
imagesc(reshape(TrainData(:,i),56,46));
